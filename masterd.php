  ...
  <div class="container">
    ...
    <div class="banner3">
      <div class="columnas">
        ...
        echo '<a href="index.php"></a><input id="usuario" name="usuario" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
		  
		  <?php 
                     $variable= $_POST['contra'];
        echo '<a href="index.php"></a><input id="contra" name="contra" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
